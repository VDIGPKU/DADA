...
class Architect(object):
    ...
    def _compute_unrolled_model(self, input, trans_images_list, target, eta, network_optimizer):
        loss = self.model._loss(input, target, trans_images_list)
    ...
    def _backward_step_unrolled(self, input_train, trans_images_list_train, target_train, input_valid, target_valid, eta, network_optimizer):
        ...
        implicit_grads = self._hessian_vector_product(vector, input_train, trans_images_list_train, target_train)
    ...
    def _hessian_vector_product(self, vector, input, trans_images_list, target, r=1e-2):
